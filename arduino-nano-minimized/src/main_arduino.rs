...
use arduino_hal::pac::adc::didr0::DIDR0_SPEC;
...
pub fn main_arduino() -> ! {
    ...
    let interface = ssd1306::I2CDisplayInterface::new(i2c);//RefCellDevice::new(&i2c_ref_cell));
    let mut display = Ssd1306::new(interface, DisplaySize128x32, DisplayRotation::Rotate0)
        .into_buffered_graphics_mode();

    // let display = adafruit_ssd1306::AdafruitSSD1306Driver::new(i2c);
    let mut button1_pin = pins.d7.into_pull_up_input();
    let mut button2_pin = pins.d8.into_pull_up_input();
